...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=608, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        try:
            ...
            self.img_files = [x.replace('/', os.sep) for x in f if os.path.splitext(x)[-1].lower() in img_formats]  # sorted() disabled
        ...
        # Check cache
        cache_path = 'cache/' + str(Path(self.label_files[0]).parent) + '.cache'  # cached labels

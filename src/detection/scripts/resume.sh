...
python train.py --device 0 --batch-size 32 --img 608 608 --data cfg/satellite.data.yaml \
--cfg cfg/satellite-anchor-608-new-new.cfg --hyp cfg/hyp.scratch.yaml --resume \
--weights runs/exp60_0822-no-intersect-608-new-new/weights/299.pt \
--name 0822-no-intersect-608-new-new-400resume \

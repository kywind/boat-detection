...
python train.py --device 0,1 --batch-size 32 --img 608 608 \
--data cfg/satellite.data.yaml --cfg cfg/satellite-anchor-608.cfg --hyp cfg/hyp.scratch.yaml \
--weights weights/yolov4.conv.137 \
--name 0919-608 --single-cls --epochs 400
